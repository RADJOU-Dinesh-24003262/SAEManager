...
/**
 * Integration tests for SaeCreateController
 *
 * @category Test
 *
 * @package Tests
...
class SaeCreateControllerIntegrationTest extends TestCase
{
    /**
    ...
    public function supportMethodWorksWithoutControllerInstance(): void
    {
        ...
        $result = SaeCreateController::support('/sae/create', 'GET');
    ...
    public function integrationTestWithReflection(): void
    {
        ...
        $controller = new SaeCreateController();
