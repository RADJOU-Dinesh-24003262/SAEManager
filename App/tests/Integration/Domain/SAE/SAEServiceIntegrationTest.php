...
use App\Domain\SAE\Repository\SAEGroupRepository;
use App\Domain\SAE\Repository\SAESubjectRepository;
...
class SAEServiceIntegrationTest extends TestCase
{
    ...
    public function canCreateSAEAndGroups(): void
    {
        ...
        $this->assertNotNull($subject->getId());
        $this->saeId = $subject->getId();

        $this->assertEquals($saeData['subject_name'], $subject->getName());
        ...
        $this->assertEquals($this->saeId, $data['subject']->getId());
