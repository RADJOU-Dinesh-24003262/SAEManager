...
/**
 * Unit test for SaeToDoController class.
 *
 * @category Tests
...
class SaeToDoControllerTest extends TestCase
{
    /**
    ...
    {
        $this->assertFalse(SaeToDoController::support('/invalid', 'GET'));
        $this->assertFalse(SaeToDoController::support('/to-do-list', 'POST'));
    }
}
