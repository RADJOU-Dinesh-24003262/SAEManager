...
class ToDoListUpdatePostTest extends TestCase
{
    ...
    {
        $this->assertFalse(SaeToDoUpdatePostController::support('/sae/10/to-do/update/5', 'GET')); // Wrong method
        $this->assertFalse(SaeToDoUpdatePostController::support('/to-do-list/update/5', 'POST')); // Old path
        $this->assertFalse(SaeToDoUpdatePostController::support('/sae/10/to-do/unknown/5', 'POST')); // Invalid action
    }
}
