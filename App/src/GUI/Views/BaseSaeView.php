...
abstract class BaseSaeView extends AbstractView
{
    ...
    {
        return [
            'SAE_NUM' => $this->data['sae']['subject']->getId(),
            'SAE_NAME' => $this->data['sae']['subject']->getName(),
    ...
    protected function getMenuSae(): string
    {
        ...
        if ($user->isStudent()) {
            ...
            if ($user->getUserId() === $this->data['sae']['subject']->getResponsibleProfessorId()) {
