...
use App\Infrastructure\Exception\DatabaseFetchException;
...
use App\GUI\Views\User\LoginView;
/**
...
class LoginPost implements ControllerInterface
{
    ...
    public function control(): void
    {
        ...
        try {
            ...
            Logger::log('LOGIN_ATTEMPT', "Tentative de connexion pour : {$userEmail}");

            $useCase = new LoginUserUseCase(new PdoUserRepository());
            $user = $useCase->execute($userEmail, $data['password']);
            ...
            Logger::log('LOGIN_FAIL', "Échec authentification pour : {$userEmail}", null, 'WARNING');
