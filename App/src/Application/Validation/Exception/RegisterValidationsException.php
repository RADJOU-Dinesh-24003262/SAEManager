 ...
 */
class RegisterValidationsException extends Exception
{
    /**
     * @var RegisterValidationException[] Array of individual field validation errors
     */
    private array $errors;

    /**
     * Constructor for the RegisterValidationsException class.
     *
     * Initializes the exception with a list of validation errors.
     *
     * @param  RegisterValidationException[] $errors Array of validation error objects.
     * @return void
     */
