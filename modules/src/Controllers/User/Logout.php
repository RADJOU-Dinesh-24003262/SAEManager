 ...
 * @author Benhafessa Alexandre, Dargentolle Francois,
 *         Edelstein William, Griguer Nathan, Radjou Dinesh
 */
class Logout implements ControllerInterface
{
    ...
    public function control(): void
    {
        ...
        SessionService::setFlash('success', 'Vous avez été bien déconnecter de votre session.');
     ...
     * @return bool True if path is /logout and method is GET
     */
