...
class TokenService
{
    ...
    public static function validateToken(string $token): array
    {
        ...
        if (!preg_match('/^[a-f0-9]{64}$/i', $token)) {
            throw new ExceptionInvalidToken("Token invalide.");
        }
        ...
        if (strtotime($result['expires_at']) < time()) {
            throw new ExceptionInvalidToken("Ce lien de réinitialisation a expiré. Veuillez faire une nouvelle demande.");
        }
